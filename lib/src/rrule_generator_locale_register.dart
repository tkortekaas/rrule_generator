...
class RRuleTextDelegateRegistry {
  static final Map<RRuleLocale, RRuleTextDelegate> _delegates = {
    ...
    RRuleLocale.is_IS: const IcelandicRRuleTextDelegate(),
    ...
    RRuleLocale.se_SE: const NorthernSamiRRuleTextDelegate(),
    RRuleLocale.no_NO: const NorwegianRRuleTextDelegate(),
